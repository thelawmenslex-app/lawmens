...
const Content = () => {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 h-fit md:h-[calc(100vh-12rem)] overflow-hidden">
      
      {/* 1. Categories Column */}
      <div className="flex flex-col bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden h-[400px] md:h-full">
